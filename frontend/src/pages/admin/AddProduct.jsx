      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Create a new ethnic design for the storefront catalog</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={submitHandler} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="md:col-span-2">
              ...
              <input 
                type="text" 
                required
                placeholder="e.g. Royal Maroon Silk Chaniya Choli with Gamthi Work"
                value={name}
              ...
              <label className="relative flex items-center gap-3 cursor-pointer select-none">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-slate-800 flex items-center gap-1.5">
                    <Sparkles size={14} className="text-amber-500" /> Featured on Homepage
                  </span>
                  <span className="text-[11px] text-slate-400">Showcase in the Royal Highlights carousel</span>
                </div>
              </label>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea 
                required
                rows="4"
                placeholder="Describe the fabric, flare length, dupatta work, blouse embroidery, and occasion suitability..."
                value={description}
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 md:p-8 space-y-5">
          ...
          <div className="pt-2 flex flex-wrap items-center gap-3">
            <input 
              type="text" 
              placeholder="Custom color name (e.g. Rust Orange)"
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 md:p-8 space-y-5">
          ...
          <div className="border-2 border-dashed border-slate-200 hover:border-[#800020]/50 rounded-2xl p-6 text-center bg-slate-50/50 hover:bg-slate-50 transition-all cursor-pointer relative">
            ...
            <div className="flex flex-col items-center justify-center space-y-2 pointer-events-none">
              ...
              <div>
                <p className="text-sm font-bold text-slate-800">Click or drag & drop to upload images</p>
                <p className="text-xs text-slate-400">PNG, JPG, WEBP up to 5MB (Upload multiple for gallery)</p>
              </div>
              {uploading && (
